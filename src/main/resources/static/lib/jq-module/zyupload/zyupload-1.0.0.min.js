        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '						<div class="uploadImg" style="width:30px">';
                    html += '							<img class="upload_image" src="static/lib/jq-module/zyupload/images/add_img.png" style="width:expression(this.width > ' + imgWidth + " ? " + imgWidth + 'px : this.width)" />';
                    html += "						</div>";
                    html += "					</a>";
                    html += "				</div>";
                    html += "			</div>";
